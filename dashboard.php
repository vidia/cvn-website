  ...
  <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          ?>
          <h1 class="page-header">Dashboard <small><?= $helloArray[$randHello] . " " . $_SESSION["Name"] . " <a href='my-account.php#breakdown' rel='tooltip' title='Total points' class='label label-info'>" . $_SESSION["Points"] . "</a>"; ?></small></h1>
          <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          ...
          <p>Below is a list of events that you can request to usher. Simply click the <span class='label label-success'><i class="fa fa-plus-circle"></i> Request Event</span> button and your name will be submitted to usher the event.</p>
             <?php
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        <p><i class="fa fa-clock-o"></i> <?=date("F j, Y, g:i a", strtotime($row['CallTime'])) ?>
                          <button type="button" class="btn btn-sm btn-default pull-right" data-toggle="collapse" data-target="#desc<?= $counter; ?>">
        ...
        <div class="col-sm-4">
          ...
          <p>Below is a list of events you've requested to usher. A few days before the event, the Usher Coordinator will choose the ushers for a show based on point total.</p>
          <?php
           ...
           $counter = 0;
              ...
              ?>
                      <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <p><i class="fa fa-clock-o"></i> <?=date("F j, Y, g:i a", strtotime($row['CallTime'])) ?>
                            <button type="button" class="btn btn-sm btn-default pull-right" data-toggle="collapse" data-target="#descRequested<?= $counter; ?>">
                              <i class="fa fa-eye"></i> Toggle Description
                            </button>
                          <br />
                          <i class="fa fa-building-o"></i> <?= $row["Location"] ?></p>
        ...
        <div class="col-sm-4">
          ...
          <p>Below is a list of events that you are scheduled to usher. You can cancel your attendance up to 48 hours before a show with no point deduction. <a href="http://www.purduecvn.com/resources/">Learn more about points</a>.</p>
           <?php
