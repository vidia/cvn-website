            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        while ($season = mysql_fetch_array($result)) :
                            ?>
                            <tr>
                                <td style="text-align: center; vertical-align: middle;"><?php if ($season["Current"] == 1) {
                                    ...
                                    <form class="form-inline" role="form" method="post" action="doEditSeason.php">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="seasonName"
                                                   value="<?= $season["Season"] ?>">
                                            <input type="hidden" class="form-control" name="seasonID"
                                                   value="<?= $season["SeasonID"] ?>">
                                            <input type="hidden" class="form-control" name="action" value="edit">
                                        </div>
                                        <button action="submit" class="btn btn-default"><i class="fa fa-edit"></i>
                                        </button>
                                    </form>
                ...
                <div class="col-md-7">
                    <div class="well well-sm">
                        ...
                        <p>Seasons are periods of times designated by the CVN Executive Team. As of August 2014, a
                            "Season" consists of one semester.</p>

                        <p>Currently, point totals are affected by seasons. Points are awarded to ushers based on their
                            last season's activity. Ushers receive one tenth of their previous season's point total
                            rounded up to the nearest ones value.</p>

                        <p>You cannot modify previous seasons. In addition, the ability to delete seasons is
                            deactivated. Contact your <a href="mailto:kenny@digital-inflection.com">webmaster</a> to
                            delete a season.</p>

                        <p>To change the current season, visit the <a href="event-admin.php">Event Administrator</a>.
                        </p>
                    </div>
                </div>
