...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Reset Password
                <small>Update your password to log into your account</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="/">Home</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            ?>
            <form class="form-horizontal" enctype="application/x-www-form-urlencoded" action="doReset.php"
                  method="post">
