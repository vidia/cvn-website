...
<div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          ?>
          <h1 class="page-header">Manage Users <small><?= $helloArray[$randHello] . " " . $_SESSION["Name"] . " <a href='my-account.php#breakdown' rel='tooltip' title='Total points' class='label label-info'>" . $_SESSION["Points"] . "</a>"; ?></small></h1>
          <ol class="breadcrumb">
