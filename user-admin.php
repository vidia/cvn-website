        ...
        <div class="col-lg-12">
            ...
            <script>
                function Verify_Delete(num) {
                    ...
                    if (r == true) {
                        window.location.href = '/actions/doDeleteUser.php?ID=' + num
                    }
                    else {
                        return false;
                    }
                ...
                <form action="actions/doSearchUser.php" method="post" role="form">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" rel="typeahead" class="form-control" id="search" name="terms"
                                   placeholder="Search Users">
			    	<span class="input-group-btn">
			    		<button type="submit" class="btn btn-default" type="button"><i class="fa fa-search"></i> <span
