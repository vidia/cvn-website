    ...
    <div id="container">
        ...
        <div id="content">
            <div id="main" class="float-left">
                ...
                <p>Students for the Arts!!! Convocations Voice Network (CVN) was officially established in 1985 to
                    support and promote the performing arts presentations brought to campus by Convocations. Today, CVN
                    has a membership of more than 300 students from various majors and backgrounds and participates in
                    every performance of the season.</p>
                <br/>
                <strong>What does CVN do?</strong>

                <p>CVN provides volunteer ushering for all of the Convocations events in Elliott Hall, Loeb Playhouse,
                    and Fowler Hall each season. All members ushering for a given show are invited to stay and see that
                    show for FREE! CVN members may usher for as many or as few shows as they like.</p>
                <br/>

                <p>CVN also takes part in a variety of special events, including receptions with the performers, parties
                    with the patrons, and lots of social activities.</p>
                <br/>
