...
<div class="row">
    <div class="col-lg-12">
        ...
        <h1 class="page-header">Edit Event
            <small><?= $helloArray[$randHello] . " " . $_SESSION["Name"] . " <a href='my-account.php#breakdown' rel='tooltip' title='Total points' class='label label-info'>" . $_SESSION["Points"] . "</a>"; ?></small>
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select class="form-control" name="Type" id="Type">
                        ...
                        <option value="Meeting"<?php if ($row['Type'] == 'Meeting') {
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="MeetingLoc" id="MeetingLoc"
                           value="<?php echo $row['MeetingLoc']; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="SpecialInstr"
                              id="SpecialInstr"><?php echo $row['SpecialInstr']; ?></textarea>
                </div>
            </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input class="form-control" type="text" name="UpTime" id="UpTime" maxlength="25" size="25"
                               value="<?php echo date("m-d-Y h:iA", strtotime($row['UpTime'])); ?> "/>
                        <span class="input-group-addon"><a style='color:#000; cursor: pointer;'
                                                           onclick="javascript:NewCssCal ('UpTime','MMddyyyy','arrow',true,'12')"><i
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input class="form-control" type="text" name="EndTime" id="EndTime" maxlength="25" size="25"
                               value="<?php echo date("m-d-Y h:iA", strtotime($row['EndTime'])); ?>"/>
                        <span class="input-group-addon"><a style='color:#000; cursor: pointer;'
                                                           onclick="javascript:NewCssCal ('EndTime','MMddyyyy','arrow',true,'12')"><i
                                    class="fa fa-calendar"></i></a></span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input class="form-control" type="text" name="CallTime" id="CallTime" maxlength="25" size="25"
                               value="<?php echo date("m-d-Y h:iA", strtotime($row['CallTime'])); ?>"/>
                        <span class="input-group-addon"><a style='color:#000; cursor: pointer;'
                                                           onclick="javascript:NewCssCal ('CallTime','MMddyyyy','arrow',true,'12')"><i
                                    class="fa fa-calendar"></i></a></span>
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div style="margin-left: 15px;">
                ...
                <i rel='tooltip' title="Post Time"
                   class="fa fa-clock-o"></i>  <?= date("M d, Y", strtotime($row['UpTime'])) ?>
                at <?= date("h:i A", strtotime($row['UpTime'])) ?><br/>
                <i rel='tooltip' title="Call Time"
                   class="fa fa-sign-in"></i>   <?= date("M d, Y", strtotime($row['CallTime'])) ?>
                at  <?= date("h:i A", strtotime($row['CallTime'])) ?> <br/>
                <i rel='tooltip' title="End of Show"
                   class="fa fa-sign-out"></i> <?= date("M d, Y", strtotime($row['EndTime'])) ?>
                at <?= date("h:i A", strtotime($row['EndTime'])) ?><br/>
                <i rel='tooltip' title="User Coordinator" class="fa fa-user"></i> <a
                    href="mailto:<?= $row["UC"] ?>"><?= $row["UC"] ?></a>
