    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="passNotice" style="display: none;">
                <div class="alert alert-info">Your password is not required to modify your profile. If you do not want
                    your password changed, you may leave these fields blank.
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" onFocus="showthetable('passNotice')" type="password" name="password"
                           id="password"/>
                </div>
            </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" placeholder="Year" type="text" name="bdyear"
                                   value="<?php echo $row["bdyear"]; ?>" maxlength="4" size="4"/>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" id="movie" name="movie"
                           value="<?php echo $row['movie']; ?>"/>
                </div>
            </div>
                ...
                <div class="col-sm-10">
                    <div class="checkbox">
                        <label>
                            ...
                            } ?> /> Yes, I am interested in being contacted to help with marketing events in exchange
                            for show tickets
                        </label>
                    </div>
                </div>
