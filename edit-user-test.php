...
while ($row = mysql_fetch_array($result)) {
    ...
    <?php if ($_SESSION['AccountType'] == 'ADMIN') { ?>
        ...
        <form class="form-horizontal" action="doEditUser.php" method="post">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="username" id="username"
                                   disabled="disabled" value="<?php echo $row['Username']; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="points" id="points" disabled="disabled"
                                   value="<?php echo getPoints($_GET['ID']); ?>"/>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div id="passNotice" style="display: none;">
                        <div class="alert alert-info">A password is not required to modify the user's profile. If
                            you do not want their password changed, you may leave these fields blank.
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" onFocus="showthetable('passNotice')" type="password"
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="grad" id="grad" maxlength="4"
                                   value="<?php echo $row['GraduationDate']; ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="checkbox" name="marketing"
                                   id="marketing" <?php if ($row['Marketing'] == chr(0x01)) {
                                echo "checked='checked'";
                            } ?> /> User is interested in being contacted to help with marketing events in exchange
                            for show tickets
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <input class="btn btn-success btn-block" type="submit" value="Edit User" name="edit-user"
                           id="edit-user"/>
                    <input onclick='return Verify_Delete('.$row['ID'].')' style='cursor: pointer;' rel='tooltip'
                    title='Delete " . $row['FirstName'] . " " . $row['LastName']. "' class='btn btn-danger'><i
                        class='fa fa-trash-o'></i></input>
            ...
            <div class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <p class="list-group-item-text">
                        ...
                        1(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                           title="Points for Shows Ushered"><?php echo $points['Present'] * 1; ?></acronym></strong>)
                        + 15(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                              title="Shows Cut"><?php echo ($points['Cut'] + $points['Late-Add-Cancel']) * 1; ?></acronym></strong>)
                        - 45(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                              title="Shows Signed Up & Skipped"><?php echo $points['No-Show'] * 1; ?></acronym></strong>)
                        - 15(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                              title="Shows Cancelled Within 48 Hours of Call Time"><?php echo $points['Cancelled'] * 1; ?></acronym></strong>)
                        - 15(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                              title="Arrived More Than 15 Minutes Late"><?php echo $points['Late'] * 1; ?></acronym></strong>)
                        + 5(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                             title="Arrived Less Than 15 Minutes Late"><?php echo $points['Tardy'] * 1; ?></acronym></strong>)
                        + 5(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                             title="Dress Code Violation"><?php echo $points['Dress-Violation'] * 1; ?></acronym></strong>)
                        + 3(<strong><acronym rel="tooltip" style="cursor: pointer;"
                                             title="Social Events/Meetings"><?php echo $points['Meeting'] * 1; ?></acronym></strong>)
                        + <strong><acronym rel="tooltip" style="cursor: pointer;"
                                           title="Years Involved"><?php echo $years * 1; ?></acronym></strong>
                        + <strong><acronym rel="tooltip" style="cursor: pointer;"
                                           title="Previous Semester Rollover"><?php echo $previousPoints; ?></acronym></strong>
                    </p>
                </li>
            </div>
        </div>
...
<?php
    ...
    <a class="btn btn-success pull-right" href="add-attendance.php?ID=<?php echo $_GET["ID"]; ?>">Add Attendance</a><br
                ...
                while ($event = mysql_fetch_array($resultEvent)) {
                    ...
                    <form class="form-horizontal" action="doEditAttendance.php" method="post">
                        <tr>
                            ...
                            <td width="15%">
                                <a class="btn btn-danger" onclick='return Verify_Delete()'
                                   href="doEditAttendance.php?action=delete&user=<?php echo $_GET["ID"]; ?>&ID=<?php echo $attendance["ID"]; ?>">Delete</a>
                            </td>
                        </tr>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            if ($_SESSION["AccountType"] == "ADMIN") {
                ?>
                <!-- Modal -->
                <div class="modal fade" id="ucDefault" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                     aria-hidden="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="reason">
                                                ...
                                                <option name="Failure to Attend Enough Shows">Failure to Attend Enough
                                                    Shows
                                                </option>
                                                <option name="Failure to Work Assigned Position">Failure to Work
                                                    Assigned Position
                                                </option>
                                                <option name="Failure to Work Concession">Failure to Work Concession
                                                </option>
                                                <option name="Failure to Perform Tasks Effectively">Failure to Perform
                                                    Tasks Effectively
                                                </option>
                                                <option name="Failure to Perform Duties per the Constitution">Failure to
                                                    Perform Duties per the Constitution
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                ...
                <button class="btn btn-success pull-right" data-toggle="modal" data-target="#ucDefault">Add Default
                </button>
                ...
                if ($numberResults > 0) {
                    ...
                    while ($defaults = mysql_fetch_array($resultDefaults)) {
                        ...
                        <td width="20%">
                            <a class="btn btn-danger" onclick='return Verify_Delete()'
                               href="doEditDefault.php?action=delete&user=<?php echo $_GET["ID"]; ?>&ID=<?php echo $defaults["DefaultID"]; ?>">Remove</a>
                        </td>
                        </tr>
                    <?php
                    } //end while
