    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <form class="form-horizontal" action="doEditAttendance.php" method="post">
                <div class="alert alert-info">Use this page only when <b>adding</b> attendance. If the user already has
                    attendance marked for the event,
                    please modify it through the <a class="alert-link" href="user-admin.php">user's profile page</a>.
                </div>
