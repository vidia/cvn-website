...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h1 class="page-header">Manage Meeting Attendance
        ...
        <div class="col-lg-12">
            ...
            <form action="doMeetingAttendance.php" method="post">
                <table class="table table-hover table-striped table-bordered">
                    <tr>
                        <thead>
                        <th style='width: 3%;'><input type="checkbox" name="checkall" id="checkall"/></th>
                        <th>Name</th>
                        <th>Email</th>
                    </tr>
                    </thead>
                ...
                <button class="btn btn-success btn-block" type="submit" id="submit-attendance"
