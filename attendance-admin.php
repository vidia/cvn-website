                    ...
                    <div id="collapse<?= $i ?>" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <a class="btn btn-default pull-right"
                               href="export-event-list.php?ID=<?php echo $row['ID']; ?>"><i class="fa fa-download"></i>
                                Download Usher List</a>
                            ...
                            <form class="form-inline" action="doPullAttendanceFixed2.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input placeholder=" #" type="text" name="number-pull" id="number-pull"
                                           style="width: 50px;" class="form-control" maxlength="3"/>
        ...
        while ($row = mysql_fetch_array($result)) {
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseB<?= $i ?>" class="panel-collapse collapse <? //if($i==0) { echo "in"; }?>">
                    <div class="panel-body">
                        <a class="btn btn-default pull-right"
                           href="export-event-attendance.php?ID=<?php echo $row['ID']; ?>"><i
                                class="fa fa-download"></i> Download Event Attendance</a>
                        <a style="display:none;" class="btn btn-success pull-right" style="margin-right: 10px;"
                           rel="<?php echo $row['ID']; ?>"><i class="fa fa-plus"></i> Add extra</a>
                        ...
                        <input class="btn btn-lg btn-success btn-block" type="submit" name="submit-event-attendance"
