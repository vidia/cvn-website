        ...
        <div class="navbar-header">
            ...
            <?php if (!empty($_SESSION["UID"])) { ?>
                <a class="navbar-brand" href="/dashboard.php"><img
                        src="http://www.purduecvn.com/wp-content/uploads/2014/03/logo_main.png"/></a>
            <?php } else { ?>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav navbar-right" style="margin-top: 10px;">
                ...
                <?php if ($_SESSION["AccountType"] == "ADMIN" || $_SESSION["AccountType"] == "UC") { ?>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-lock"></i> Control
                            Panel <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="/event-admin.php"><i class="fa fa-calendar-o"></i> Events</a></li>
                            <li><a href="/attendance-admin.php"><i class="fa fa-check-square-o"></i> Attendances</a>
                            </li>
                            <li><a href="/meeting-admin.php"><i class="fa fa-check-square-o"></i> Meeting
                                    Attendances</a></li>
                ...
                if (!empty($_SESSION["UID"])) {
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                class="fa fa-user"></i> <?= $_SESSION["Name"] ?> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
...
if ($settings["isMaintenance"]) :
    ...
    <div class="container">
        <div class="row">
            <div class="alert alert-warning"><i class="fa fa-warning"></i> <strong>MAINTENANCE MODE</strong> - This site
                is currently undergoing maintenance. Ushers and Usher Coordinators cannot log in at this time.
            </div>
        </div>
    </div>
<?php endif; ?>
