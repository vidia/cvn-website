...
<div id="container">
    ...
    <div id="content">
        <div id="main" class="float-left">
            ...
            <strong>A</strong>: <a target="_blank" href="assets/files/CVN_E-Board_Application_2010_Spring.pdf">Click
                here.</a><br/><br/>

            <strong>Q</strong>: Where can I find more information about the club?<br/>

            <strong>A</strong>: Try our <a target="_blank"
                                           href="assets/files/CVN_Member_Information_Guide_fall 2011.pdf">Member
                Information Guide</a><br/><br/>

            <strong>Q</strong>: Where can I see powerpoints from the General meeting? <br/>
            <strong>A</strong>: Try our <a target="_blank" href="assets/files/cvn_powerpoint.pptx">CVN
                Powerpoint</a><br/><br/>
            ...
            <strong>A</strong>: You will be notified if you have made the list or not 7 days before the event. If you
            didn't make the list the first time around you will be put on a substiution list and might still have a
            chance to usher if somebody on the show list cancels. You will be emailed in this case.<br/><br/>


            <strong>Q</strong>: When is the last time I'm able to cancel ushing a show without a penelty?<br/>

            <strong>A</strong>: 48 hours before calltime. There are people waiting to hear from us about people
            canceling, so please do it as soon as possible.<br/><br/>
