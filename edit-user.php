        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="username" id="username" disabled="disabled"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div id="passNotice" style="display: none;">
                    <div class="alert alert-info">A password is not required to modify the user's profile. If you do
                        not want their password changed, you may leave these fields blank.
                    </div>
                </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        } ?> /> User is interested in being contacted to help with marketing events in exchange for
                        show tickets
                    </div>
                </div>
            </div>
        ...
        <div class="list-group">
            ...
            <li class="list-group-item">
                ...
                <p class="list-group-item-text">
                    ...
                    + 7(<strong><acronym rel="tooltip" style="cursor: pointer;"
