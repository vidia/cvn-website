...
<form class="form-horizontal" action="doAddEvent.php" method="post">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input placeholder="NEEDTOBREATHE Concert" class="form-control" type="text" name="Name"
                           id="Name"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="help-block">An exception will not allow a user to sign up for both this show
                        and the show you select above.
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input placeholder="Loeb Playhouse" class="form-control" type="text" name="Location"
                           id="Location"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input placeholder="Some info about this event" class="form-control" type="text"
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input placeholder="Use the calendar button to the right to select."
                               class="form-control" type="text" name="UpTime" id="UpTime" maxlength="25"
                               size="25"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input placeholder="Use the calendar button to the right to select."
                               class="form-control" type="text" name="EndTime" id="EndTime" maxlength="25"
                               size="25"/>
                                    <span class="input-group-addon"><a style='color:#000; cursor: pointer;'
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        <input placeholder="Use the calendar button to the right to select."
                               class="form-control" type="text" name="CallTime" id="CallTime" maxlength="25"
                               size="25"/>
                                    <span class="input-group-addon"><a style='color:#000; cursor: pointer;'
    ...
    <div class="form-group">
        <div class="col-sm-12">
            <button class="btn btn-success btn-block" type="submit" name="submit-eventl" id="submit-event"/>
