...
var CalWidth = 230;// calendar width
...
var CalPosOffsetX = -7; //X position offset relative to calendar icon, can be negative value
var CalPosOffsetY = 125; //Y position offset relative to calendar icon, can be negative value

//Configurable parameters

//var WindowTitle = "DateTime Picker";//Date Time Picker title.

var SpanBorderColor = "#363133";//span border color
var SpanBgColor = "#FFFFFF"; //span background color
var MonthYearColor = "#cc0033"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#7F7F7F"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#cdcdcd"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#cdcdcd"; //Background color of Saturday.
var WeekDayColor = "#dedede"; //Background color of weekdays.
var FontColor = "#000000"; //color of font in Calendar day cell.
var TodayColor = "#47a447"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#DEDE00"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
var DisableColor = "#D96248"; //color of disabled cell.
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime = "<tr><td colspan='7' style=\"text-align:center;\"><br /><table style='margin:5px;' border='0' width='199px' cellpadding='0' cellspacing='0'><tbody><tr><td height='5px' width='" + HourCellWidth + "'>&nbsp;</td>";
		...
		vCalTime += "<tr><td colspan='7'>&nbsp;</td></tr><tr><td colspan='7' style=\"text-align:center;\"><input class='btn btn-success' style='width:60px;font-size:12px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input class='btn btn-default' style='width:60px;font-size:12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
	}
