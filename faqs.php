...
<div id="container">
    ...
    <div id="content">
        <div id="main" class="float-left">
            ...
            <strong>A</strong>: <a target="_blank" href="assets/files/2013_Written_Application.pdf">Click here for
                application for Fall 2013!</a><br/><br/>

            <strong>Q</strong>: Where can I find more information about the club?<br/>

            <strong>A</strong>: Try our <a target="_blank" href="assets/files/cvn_brochure.pdf">Member Information
                Guide</a><br/><br/>

            <strong>Q</strong>: Where can I see powerpoints from the General meeting? <br/>
            <strong>A</strong>: Try our <a target="_blank" href="assets/files/2012_08_28_Fall_Callout.pptx">CVN
                Powerpoint</a><br/><br/>
            ...
            didn't make the list the first time around you will be put on a waiting list and might still have a chance
            to usher if somebody on the show list cancels. You will be emailed in all cases.<br/><br/>


            <strong>Q</strong>: When is the last time I'm able to cancel ushing a show without a penalty?<br/>

            <strong>A</strong>: 48 hours before calltime. There are people waiting to hear from us about cancellations,
            so please do it as soon as possible.<br/><br/>
