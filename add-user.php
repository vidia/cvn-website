        ...
        <div class="col-lg-12">
            ...
            <form class="form-horizontal" action="doAddUser.php" method="post">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="firstname" id="firstname"
                                       value="<?php echo $_SESSION['nFirstName']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="lastname" id="lastname"
                                       value="<?php echo $_SESSION['nLastName']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="email" id="email"
                                       value="<?php echo $_SESSION['nEmail']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="confirm-email" id="confirm-email"
                                       value="<?php echo $_SESSION['nCEmail']; ?>"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form class="form-horizontal" action="doAddUser.php" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input class="btn btn-success btn-block" type="submit" value="Add User" name="add-user"
                                   id="add-user"/>
                        </div>
                    </div>
...
<input type="checkbox" value="1" name="marketing" id="marketing" <?php if ($_SESSION['nMarketing'] == '1') {
    echo 'checked="checked"';
} ?> /> User is interested in being contacted to help with marketing events in exchange for show tickets
<br /><br />
</fieldset> -->