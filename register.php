...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Register an Account
            <small>Start ushering today and create an account</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/">Home</a></li>
...
<div class="row">
    <div class="col-lg-8">
        ...
        <form class="form-horizontal" enctype="application/x-www-form-urlencoded" action="doRegister.php"
              method="post">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" placeholder="John" type="text" name="firstname"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" placeholder="Doe" type="text" name="lastname" id="lastname"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" placeholder="jdoe@purdue.edu" type="email" name="email"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" placeholder="jdoe@purdue.edu" type="email"
                                   name="confirm-email" id="confirm-email"
                                   value="<?php echo $_SESSION['CEmail']; ?>"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="grad" maxlength="4" id="grad"
                                   value="<?php echo $_SESSION['Grad']; ?>"/>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="1" name="marketing"
                                           id="marketing" <?php if ($_SESSION['Marketing'] == '1') {
                                        echo 'checked="checked"';
                                    } ?> /> Yes, I am interested in being contacted to help with marketing events in
                                    exchange for show tickets
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <button class="btn btn-success btn-block" type="submit" name="register" id="register"/>
                    Register Now</button>
                </div>
            </div>
        </form>
    ...
    <div class="col-sm-4">
        <img src="assets/images/register.jpg" class="img-responsive img-thumbnail"
             alt="Register today for great rewards!"/>
