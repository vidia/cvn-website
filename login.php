           ...
           if($_SESSION['success'] != '') {
			...
			<form class="form-horizontal" enctype="application/x-www-form-urlencoded" action="actions/doLogin.php" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<button type="submit" name="login" id="login" class="btn btn-success">Log In</button> <small><a style="cursor:pointer;" data-toggle="modal" data-target="#myModal">Forgot your password?</a></small>
					</div>
				</div>
			      ...
			      <div class="modal-body">
			        ...
			        <form class="form-horizontal" enctype="application/x-www-form-urlencoded" action="actions/doRecover.php" method="post">
			        	<div class="form-group">
							...
							<div class="col-sm-6">
								<input placeholder="jdoe@purdue.edu" class="form-control" type="text" name="resetEmail" id="resetEmail" /><br /><br />
							</div>
						</div>
			      </div>
